...
class UpdateLugarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Se pasan los valoresa a los campos de la pantalla
    ...
    private fun escribirCorreo() {
        ...
        if (valor.isNotEmpty()){//Si tiene algo se puede enviar el correo
        ...
        }else{//Si esta vacio entonces mosttrar un error
    ...
    private fun llamarLugar() {
        ...
        if (valor.isNotEmpty()){//Si tiene algo se puede enviar el mensaje
    ...
    //Hace el registro del  lugar en la base de datos
    private fun updateLugar() {
        val nombre = binding.etNombre.text.toString()
        val correo = binding.etCorreoLugar.text.toString()
        val telefono = binding.etTelefono.text.toString()
        val web = binding.etWeb.text.toString()
        if (nombre.isNotEmpty()){//al menos teneomos un nombre
